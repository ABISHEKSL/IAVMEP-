...
public class MailReading {
    ...
    public static MailReading MailReadingInstance;
    ...
    public static MailReading getinstance() {

        if (MailReadingInstance == null) {
            MailReadingInstance = new MailReading();
        }

        return MailReadingInstance;
        ...
        try {
            ...
            for (int i = messageCount; i > (messageCount - unreadMsgCount); i--) {
                ...
                if (emailSubject.contains(emailSubjectContent)) {
                    ...
                    System.out.println("INDEX::::"+myStr.indexOf("Thank you", 1));

                    String str = outputText;

                    char ch1 = str.charAt(284);


                    char ch2 = str.charAt(285);


                    char ch3 = str.charAt(286);


                    char ch4 = str.charAt(287);
                    char ch5 = str.charAt(288);
                    char ch6 = str.charAt(289);
